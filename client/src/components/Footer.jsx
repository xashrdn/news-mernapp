      ...
      >
        ...
        >
          ...
          <div className="hidden lg:block lg:w-[19vw]">
              ...
              >
                <div className="w-[5.5vw]"><img src={OneByOne} alt="" /></div>
                <div className="w-[5.5vw]"><img src={OneByOne} alt="" /></div>
                <div className="w-[5.5vw]"><img src={OneByOne} alt="" /></div>
                <div className="w-[5.5vw]"><img src={OneByOne} alt="" /></div>
                <div className="w-[5.5vw]"><img src={OneByOne} alt="" /></div>
          ...
          <div className="h-[100%] flex flex-col md:mt-[1vh] lg:mt-[0vh]">
            ...
            <div className="flex flex-col">
              ...
              />
              <button style={{transition:"0.4s"}} className=" mt-[10px] lg:w-[19vw] w-[86vw] bg-[#F65050] text-white font-bold h-[50px] hover:bg-red-500">
                SUBSCRIBE
              </button>
            </div>
          </div>
