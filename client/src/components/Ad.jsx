const Ad = () => {
    return (
      ...
      <div className="h-[3px] w-full bg-red-400 mt-3 xl:w-[22vw]"></div>
      ...
      <div>
        <div className="bg-[url('img.svg')] h-[50vh] xl:w-[22vw] xl:h-[30vh] text-[50px] xl:text-[25px] text-[#FFFFFF] font-sans-serif flex justify-center items-center">Ad</div>
      </div>
      </div>
    </div>
    )
