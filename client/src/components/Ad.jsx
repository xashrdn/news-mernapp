const Ad = () => {
    return (
      <div>
      <div className="flex">
        <p className="mr-[15vw] font-sans-serif text-red-400 text-xl">Stay Connected</p>
      </div>
      <div className="h-[3px] w-[21.4vw] bg-red-400 mt-4"></div>
      <div className="mt-[25px] flex flex-col">
        <div className="flex">
          <div className="flex mr-[20px] bg-[#4281FF] hover:bg-[#42C0F5] w-[230px] h-[60px]">
          ...
          <div className="flex mb-[20px] bg-[#C23785] hover:bg-[#F7679D] w-[230px] h-[60px]">
        ...
        <div className="flex">
          <div className="flex mr-[20px] bg-[#EF5043] hover:bg-red-400 w-[230px] h-[60px]">
          ...
          <div className="flex mb-[20px] bg-[#42C0F5] hover:bg-blue-200 w-[230px] h-[60px]">
        ...
        <div className="flex">
        <div className="flex mr-[20px] bg-[#1B7BFD] hover:bg-[#42C0F5] w-[230px] h-[60px]">
          ...
          <div className=" flex mb-[20px] bg-[#F7679D] hover:bg-pink-300 w-[230px] h-[60px]">
